...
(function() {
  ...
  $for = (function() {
    ...
    game.systems.get(Position, dot).x = (200 + (Math.floor((Math.random() * ((config.dimensions[0] / 2) - 1))) + 1));
    game.systems.get(Position, dot).y = (200 + (Math.floor((Math.random() * ((config.dimensions[1] / 2) - 1))) + 1));
    game.systems.get(Position, dot).z = 1;
