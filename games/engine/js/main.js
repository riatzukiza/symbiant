...
(function() {
  ...
  $for = (function() {
    ...
    game.systems.get(Position, dot).x = (40 + homePos.x + (Math.floor((Math.random() * (300 - 1))) + 1));
    game.systems.get(Position, dot).y = (40 + homePos.y + (Math.floor((Math.random() * (300 - 1))) + 1));
