...
(function() {
  ...
  $for = (function() {
    ...
    return spawnRock([ (Math.floor((Math.random() * (window.innerWidth - 0))) + 0), (Math.floor((Math.random() * (window.innerHeight - 0))) + 0) ], (10 + (Math.floor((Math.random() * ( - 100))) + 100)), (20 + (Math.floor((Math.random() * ( - 80))) + 80)));
  }).call(this);
  }
  ;
  return $for;
