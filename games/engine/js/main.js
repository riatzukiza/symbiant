...
(function() {
  ...
  $for = (function() {
    ...
    game.systems.get(Position, dot).x = (Math.floor((Math.random() * ((config.dimensions[0] / 2) - 1))) + 1);
    game.systems.get(Position, dot).y = (Math.floor((Math.random() * ((config.dimensions[1] / 2) - 1))) + 1);
    game.systems.get(Position, dot).z = 1;
    game.systems.get(Physics, dot).scale = 2;
    game.systems.get(Physics, dot).mass = 1;
