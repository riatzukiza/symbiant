...
(function() {
  ...
  $for = (function() {
    ...
    return spawnRock([ (Math.floor((Math.random() * (window.innerWidth - 1))) + 1), (Math.floor((Math.random() * (window.innerHeight - 1))) + 1) ], (10 + (Math.floor((Math.random() * ( - 100))) + 100)), (20 + (Math.floor((Math.random() * ( - 80))) + 80)));
  }).call(this);
  }
  ;
  return $for;
