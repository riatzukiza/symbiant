...
const Colony = extend(EntityGroup, { 
  ...
  entityType:Ant,
  id:0,
  init( nest = this.nest,color = this.color,goals = this.goals,decay = 0.05,colonies = this.colonies,foodWeights = create(Pheremones)(color, decay),matingWeights = create(Pheremones)({ 
    red:color.red,
    green:color.green,
    blue:255
